...
<div class="container mt-4 intro-index" id="intro-index">
  <div class="title-list d-flex">
    <h2>
      <a class="text-title" href="https://truyenfull.vn/danh-sach/truyen-hot/">Truyện hot</a>
    </h2>

    <select class="new-select form-select" size="lg">
  ...
  <div class="index-intro">
    ...
    <!-- Repeat the above block for each book item -->
