            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <router-link
                  class="dropdown-item"
                  to="/truyen-full"
                  @click="updateFilter('truyen-full')"
                >
                  Truyện Full
                </router-link>
              </li>
              ...
              <li>
                <router-link
                  class="dropdown-item"
                  to="/tien-hiep-hay"
                  @click="updateFilter('tien-hiep-hay')"
                >
              ...
              <li>
                <router-link
                  class="dropdown-item"
                  to="/kiem-hiep-hay"
                  @click="updateFilter('kiem-hiep-hay')"
                >
...
.navbar-default .navbar-nav .show .dropdown-menu>li>a, .dropdown-menu .row .col-md-4>li>a {
    color: #f9f9f9;
}
